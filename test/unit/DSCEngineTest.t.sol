...
contract DSCEngineTest is Test {
    ...
    function testCanDepositCollateralAndAccontInfo() public depositedCollateral {
        (uint256 tootalDscMinted, uint256 collateralValueInUsd) = dsce.getAccountInforamtion(USER);
